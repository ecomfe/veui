...
describe('components/Calendar', () => {
  ...
  it('should support customized week-start correctly.', () => {
    ...
    expect(wrapper.vm.getDayNames()[0] === wrapper.vm.daysShort[5]).to.be.true
  ...
  it('should support before solt correctly.', () => {
    ...
    expect(wrapper.find('.calendar-before').exists()).to.be.true
  })
  ...
  it('should support after solt correctly.', () => {
    ...
    expect(wrapper.find('.calendar-after').exists()).to.be.true
  })
